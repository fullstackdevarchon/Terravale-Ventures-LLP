...
const BuyerNavbar = () => {
  ...
  const navItemClass = ({ isActive }) =>
    `px-4 py-2 rounded-lg transition font-semibold text-[17px] group ${isActive
      ? "bg-[rgba(27,60,43,0.85)] border border-white/40 text-yellow-300"
      : "text-white hover:bg-[rgba(27,60,43,0.7)] hover:text-black"
    }`;
          ...
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <Link to="/buyer-dashboard" className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="w-55 h-[3px] rounded-full"></div>
              </div>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-8">
              <NavLink to="/buyer-dashboard/products" className={navItemClass}>
                <span className="inline-flex items-center gap-2">
                  <FaBoxOpen className="group-hover:text-orange-500 transition-colors" /> Products
                </span>
              </NavLink>

              <NavLink to="/buyer-dashboard/orders" className={navItemClass}>
                <span className="inline-flex items-center gap-2">
                  <FaClipboardList className="group-hover:text-purple-400 transition-colors" /> My Orders
                </span>
              </NavLink>

              <NavLink to="/buyer-dashboard/cart" className={navItemClass}>
                <span className="inline-flex items-center gap-2">
                  <FaShoppingCart className="group-hover:text-emerald-400 transition-colors" />
                  {loading ? (
              ...
              <NavLink to="/buyer-dashboard/profile" className={navItemClass}>
                <span className="inline-flex items-center gap-2">
                  <FaUser className="group-hover:text-rose-500 transition-colors" />
                  Profile
                </span>
              </NavLink>
