...
const SellerNavbar = () => {
  ...
  const navItemClass = ({ isActive }) =>
    `px-4 py-2 rounded-lg transition font-semibold text-[17px] ${isActive
      ...
      >
        ...
        {isOpen && (
          ...
          >
            ...
            >
              <FaPlusCircle className="inline mr-3 text-green-400" /> Add Product
            </NavLink>
            ...
            <NavLink
              ...
              onClick={() => setIsOpen(false)}
            >
              <FaBoxOpen className="inline mr-3 text-orange-400" /> My Products
            </NavLink>
            ...
            <NavLink
              ...
              onClick={() => setIsOpen(false)}
            >
              <FaClipboardCheck className="inline mr-3 text-blue-400" /> Check Status
            </NavLink>
